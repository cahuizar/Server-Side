...
<html lang="en">
  ...
  <div class="container h-100">
    <div class="row h-100 justify-content-center align-items-center">
      <div class="col">
        <p class="heading">Employee Register</p>
        <form class="form-signin" action="empLogin.php">
          ...
          <div class="row">
              <div class="col-6">
                  <a href="empLogin.php" class="btn btn-lg btn-secondary btn-block">Login</a>
              </div>
              <div class="col-6">
