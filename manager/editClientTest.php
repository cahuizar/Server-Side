...
<?php
    ...
    $address = $_SESSION['clientAddress'];
    $telephone = $_SESSION['clientTelephone'];
  ...
  <body>
      ...
      <div class="container">
        <div class="row h-100 justify-content-center align-items-center">
          <div class="col">
            <p class="heading">Client Information</p>
              <h2 class="form-signin-heading">Information Entered:</h2>
              <label>Name: </label><span><?php echo htmlspecialchars($name); ?></span><br /><br />
              <label>Address: </label><span><?php echo htmlspecialchars($address); ?></span><br /><br />
              <label>Phone Number: </label><span><?php echo htmlspecialchars($telephone); ?></span><br /><br />
              <label>Email Address: </label><span><?php echo htmlspecialchars($email); ?></span><br /><br />
              <br />
        </div>
      </div>
