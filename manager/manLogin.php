...
<html lang="en">
  ...
  <div class="container h-100">
    <div class="row h-100 justify-content-center align-items-center">
      <div class="col">
        <p class="heading">Management Login</p>
        <form class="form-signin" action="manDashboard.php">
          ...
          <div class="row">
              ...
              <div class="col-6">
                  <a href="manRegister.php" class="btn btn-lg btn-secondary btn-block">Register</a>
              </div>
          </div>
        </form>
